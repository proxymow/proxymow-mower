    ...
    */
    ...
    difference() {
        union() {
            ...
            //bearing bush
            translate([0, 0, drive_bearing_recess/2]) cylinder(h=drive_bearing_recess * 1, d=drive_bearing_bush_dia, $fn=32, center=true);
            //bearing bush fillet
            translate([0, 0, motor_plate_thickness/2]) circular_fillet(extent=4, dia=drive_bearing_bush_dia, angle=130);
        }//end union
            
        //axle clearance at origin
        cylinder(h=motor_plate_thickness*2, d=drive_bearing_bush_dia/2, $fn=32, center=true);
...
back_plate();
*circular_fillet(extent=10, dia=drive_bearing_bush_dia, angle=180);